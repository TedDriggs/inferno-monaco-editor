...
var _infernoCreateElement = __webpack_require__(45);

var _infernoCreateElement2 = _interopRequireDefault(_infernoCreateElement);

var _infernoComponent = __webpack_require__(44);
...
var MonacoEditor = function (_InfernoComponent) {
    (0, _inherits3.default)(MonacoEditor, _InfernoComponent);

    function MonacoEditor(props) {
        (0, _classCallCheck3.default)(this, MonacoEditor);
        return (0, _possibleConstructorReturn3.default)(this, (MonacoEditor.__proto__ || Object.getPrototypeOf(MonacoEditor)).call(this, props));
    }
    ...
    (0, _createClass3.default)(MonacoEditor, [{
        ...
        value: function render() {
            ...
            return (0, _infernoCreateElement2.default)("div", { ref: function ref(elem) {
                ...
                }, style: { width: width, height: height }, className: "inferno-monaco-container" });
        }
        /**
        ...
        value: function initMonaco() {
            var _settings2 = this.settings,
                value = _settings2.value,
                language = _settings2.language,
                theme = _settings2.theme,
                options = _settings2.options,
                onMonacoAvailable = _settings2.onMonacoAvailable;

            if (typeof monaco !== 'undefined') {
                onMonacoAvailable(monaco);
                this.editor = monaco.editor.create(this.element, Object.assign({ value: value,
                    language: language,
                    theme: theme }, options));
        ...
        value: function onDidMount() {
            ...
            var _settings3 = this.settings,
                onDidMount = _settings3.onDidMount,
                onChange = _settings3.onChange;

            onDidMount(this.editor);
            this.editor.onDidChangeModelContent(function (evt) {
                return onChange(_this4.editor.getValue(), evt);
            });
        }
    }, {
        key: 'settings',
